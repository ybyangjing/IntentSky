...
LOG_FILE=~/logs/philly_end2end404.log
...
do
    ...
    --log ~/logs/philly_end2end404_${size}.log \
    --train_rl 0 \
    --use_rl 1
...
merged_logs = []
pattern = str(log_dir / 'philly_end2end404_*.log')
...
output_path = log_dir / 'philly_end2end404.log'
